...
#define CHFL_PEON           0x00000000  /* normal member of channel */
#define CHFL_VOICE          0x00000001  /* the power to speak */
#define CHFL_CHANOP         0x00000002  /* Channel operator */
#define CHFL_BANNED         0x00000008  /* cached as banned */
#define CHFL_QUIETED        0x00000010  /* cached as being +q victim */
#define ONLY_SERVERS        0x00000020
#define ONLY_OPERS          0x00000040
